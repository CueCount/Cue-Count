const { createPerspectiveRef, addPerspectiveMemberRef, createTrendRef, createStoryRef, createConnectionRef, createVariantRef, getPerspectiveRef, getPerspectiveMembersRef, getStoriesByPerspectiveRef, getTrendRef, getStoryRef, searchTrendsRef, connectorConfig } = require('../index.cjs.js');
